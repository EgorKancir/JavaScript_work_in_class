...
var imagesList = document.querySelector(".imgs-list");
function getName(_x) {
  return _getName.apply(this, arguments);
}
function _getName() {
  _getName = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(valueInput) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.get("https://restcountries.com/v3.1/name/".concat(valueInput));
        case 3:
...
function makeHtml(countrys) {
  var markup = countrys.map(function (country) {
    return "\n            <li class=\"imgs-item\">\n                <h2 class=\"country-name\">".concat(country.name.common, "</h2>\n                <img class=\"country-flag\" src=\"").concat(country.flags.png, "\">\n            </li>\n        ");
  });
  imagesList.innerHTML = markup;
}
...
searchInput.addEventListener("input", (0, _debounce.default)(searchCountry, 250));
