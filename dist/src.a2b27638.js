...
var pagList = document.querySelector('.pagination-list');
...
var page = 2;
var fetchMovieCharacters = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var page,
      newsData,
      _yield$newsData$json,
      results,
      info,
      _args = arguments;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 1;
          _context.next = 4;
          return fetch("".concat(url, "/character?page=").concat(page));
        case 4:
        ...
        case 8:
          _yield$newsData$json = _context.sent;
          results = _yield$newsData$json.results;
          info = _yield$newsData$json.info;
  ...
  return function fetchMovieCharacters() {
...
function renderPagination(numbers) {
  var markup = numbers.map(function (number) {
    return "<li class=\"pag-item\">\n                    <a class=\"pag-link\">".concat(number, "</a>\n                </li>");
  }).join();
  pagList.innerHTML = markup;
  // pagList.insertAdjacentHTML('beforeend', markup);
}
function makeHtml(characters, numberOfPages) {
  var markup = characters.map(function (character) {
    return "\n        <li class=\"news-item\">\n            <img src=\"".concat(character.image, "\" />\n            <h1>").concat(character.name, "</h1>\n            <p>").concat(character.species, "</p>\n            <p>").concat(character.status, "</p>\n        </li>\n        ");
  }).join();
  makePagination(numberOfPages);
  newsList.innerHTML = markup;
  // newsList.insertAdjacentHTML('beforeend', markup);
}
loadMoreButton.addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
...
pagList.addEventListener('click', /*#__PURE__*/function () {
